...
We are making a breaking change to the Anchore Enterprise package name in Big Bang 3.0. The package will now be referred to as `anchoreEnterprise` instead of `anchore` in the
`values.yaml` file. 
