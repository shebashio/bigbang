...
2. Deploy the same authorization and network policies mentioned for the [previous scenario](#additional-policies) along with any other package-specific policies.
