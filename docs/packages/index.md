...
| [cert-manager](https://repo1.dso.mil/big-bang/product/packages/cert-manager) ([architecture](cert-manager.md)) | ![cert-manager Build](https://repo1.dso.mil/big-bang/product/packages/cert-manager/badges/main/pipeline.svg) | Yes | No | Yes | Yes (STRICT) |
