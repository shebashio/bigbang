...
The existing [Big Bang `oscal-component.yaml`](https://repo1.dso.mil/big-bang/bigbang/-/blob/master/oscal-component.yaml) is an older, machine-readable roll-up. The table above is a current, human-readable inventory derived from package repositories.