...
1. Follow the `Backup and rename gitlab-rails-secret` task within [Production Considerations for GitLab, Vault, and Keycloak](../configuration/production-package-considerations.md).
