...
function install_docker {
  ...
  run_batch_add "sudo DEBIAN_FRONTEND=noninteractive apt-get update && sudo DEBIAN_FRONTEND=noninteractive apt-get -y install docker-ce docker-ce-cli containerd.io=2.2.0-2~ubuntu.22.04~jammy docker-buildx-plugin docker-compose-plugin"
