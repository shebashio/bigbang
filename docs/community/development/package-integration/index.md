...
For package deprecation and downward/high-impact track changes, use [Package Lifecycle: Offboarding](../package-lifecycle/offboarding.md) and the [Package Offboarding Checklist](../package-offboarding/index.md).
