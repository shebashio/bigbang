...
- **Documentation**: Start with the [documentation guide](documentation.md)
...
Big Bang is an open-source project that welcomes contributions. You can become part of the community and extend Big Bang in the following areas:
...
Review the [package integration guide](community/development/package-integration/) if you are interested in submitting a new package. A shepherd will be assigned to the project to create a repo in the [Big Bang Community Packages](https://repo1.dso.mil/big-bang/product/community).
