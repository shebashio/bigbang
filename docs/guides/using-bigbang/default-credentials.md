...
| Fortify | `admin` | `F0rt1fy@dmiNPa$$w0rd` | You will be prompted to change the admin user password when you first attempt to login to Fortify using the default credentials |
